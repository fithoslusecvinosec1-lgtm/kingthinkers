...
window.KT_LESSONS.timbuktu = [
  ...
  // ════════════════════════════════════════════════════════
  {
    ...
    phase4_test: [
      ...
      { id: 'timbuktu-t1-t4', type: 'input', excerpt: 'Several details point to one central message about Timbuktu.', prompt: 'Type one word that names this central message.', answer: 'theme', hint_disabled: true, correctFeedback: 'Great work. You identified the central theme from the excerpt.', wrongFeedback: 'Use a one-word label for central message, such as theme.', xp: 10 }
    ],
  ...
  },
{
  ...
  // ════════════════════════════════════════════════════════
  {
    ...
    phase4_test: [
      ...
      { id: 'timbuktu-t3-t4', type: 'input', excerpt: 'The passage links protection actions to survival results.', prompt: 'Type one word that names the outcome in this excerpt.', answer: 'survival', hint_disabled: true, correctFeedback: 'Great work. Survival is the outcome named in the excerpt.', wrongFeedback: 'Use the exact outcome word shown at the end of the excerpt.', xp: 10 }
    ],
