...
window.KT_LESSONS.songhai = [
  ...
  // ════════════════════════════════════════════════════════════
  {
    ...
    phase4_test: [
      ...
      { id: 'songhai-s1-t4', type: 'input', excerpt: 'One step caused the next across Songhai’s rise.', prompt: 'Type one word that describes this step-by-step chain.', answer: 'sequence', hint_disabled: true, correctFeedback: 'Great work. The excerpt shows a sequence where each step leads to the next.', wrongFeedback: 'Use one word for ordered steps linked across events, such as sequence.', xp: 10 }
    ],
  ...
  },
{
  ...
  // ════════════════════════════════════════════════════════════
  {
    ...
    phase4_test: [
      ...
      { id: 'songhai-s3-t4', type: 'input', excerpt: 'The test asked why the writer included details and contrasts.', prompt: 'Type one word that means the writer’s reason for writing.', answer: 'purpose', hint_disabled: true, correctFeedback: 'Excellent. Purpose is the writer’s reason for including those details.', wrongFeedback: 'Use the word that means an author’s reason: purpose.', xp: 10 }
    ],
