...
window.KT_LESSONS.kush = [
  {
    ...
    phase4_test: [
      ...
      { id: 'k1-t4', type: 'input', excerpt: 'Actions in the forge led to results across the kingdom.', prompt: 'Type one word that names what those actions produced.', answer: 'results', hint_disabled: true, correctFeedback: 'Great. The excerpt explicitly says the actions produced results.', wrongFeedback: 'Use the exact effect word from the excerpt: actions led to ____.', xp: 10 }
    ],
  ...
  },
{
...

  {
    ...
    phase4_test: [
      ...
      { id: 'k3-t4', type: 'input', excerpt: 'You combined details to find one central message.', prompt: 'Type one word that names that central message.', answer: 'theme', hint_disabled: true, correctFeedback: 'Excellent. You identified the central theme in the excerpt.', wrongFeedback: 'Give a single word for a central message, such as theme.', xp: 10 }
    ],
  ...
  },
{
...

  {
    ...
    phase4_test: [
      ...
      { id: 'k5-t4', type: 'input', excerpt: 'You used details to identify one central leadership message.', prompt: 'Type one word that names this kind of central message.', answer: 'theme', hint_disabled: true, correctFeedback: 'Excellent. You identified the leadership theme clearly.', wrongFeedback: 'Use one word for a central message, like theme.', xp: 10 }
    ],
