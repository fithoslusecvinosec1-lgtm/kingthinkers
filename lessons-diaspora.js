...
window.KT_LESSONS.diaspora = [
  ...
  // diaspora-d1 â€” The Harlem Renaissance (Reading, RI.3.2)
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    id: 'diaspora-d1',
    worldId: 'diaspora',
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  // diaspora-d2 â€” Civil Rights Math (Math, 3.OA / 3.NBT / 3.MD)
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    ...
    intro: {
      kicker: 'The Diaspora Â· Math Quest',
      text: "King, the Civil Rights Movement of the 1950s and 1960s required precise organization â€” marches planned to the mile, petitions signed by the thousands, voter registration drives tracked across counties. Mathematics was a tool of justice. Today you will solve multi-step problems using all four operations, just like the organizers who used math to change America.",
      sage: "Freedom required organization. Organization required math. Let us use it together. âœŠ"
    },
    ...
    phase1_concept: {
      ...
      example: {
        ...
        equation: 'Step 1: 8 Ã— 45 = 360 marchers. Step 2: 360 + 126 = 486 signatures.',
        visual: 'two_step',
        visual_data: {
          type: 'operation_choice',
          step1: { operation: 'multiplication', reason: 'equal groups', equation: '8 Ã— 45 = 360' },
          step2: { operation: 'addition', reason: 'combining totals', equation: '360 + 126 = 486' }
        }
      },
      sage: "Label each step: what are you doing â€” combining, comparing, splitting, or grouping? Choose your operation from that label. Watch me work through two problems."
    },
    ...
    phase2_worked: [
      {
        ...
        equation: '381 Ã— 40,000 = ? (use estimation first)',
        steps: [
          { display: 'Estimate first: 381 â‰ˆ 400. 400 Ã— 40,000 = ?', explanation: 'Round 381 to 400 for a quick estimate.', visual: 'estimate shown' },
          { display: '4 Ã— 4 = 16, add five zeros â†’ 16,000,000 estimated trips', explanation: '400 Ã— 40,000: 4Ã—4=16, then 5 zeros total. About 16 million trips.', visual: '16,000,000 estimate' },
          { display: 'Exact: 381 Ã— 40,000. Use 381 Ã— 4 Ã— 10,000', explanation: '381 Ã— 4 = 1,524. Then 1,524 Ã— 10,000 = 15,240,000 trips.', visual: '15,240,000 exact' }
        ],
      ...
      },
      {
        ...
        equation: 'Step 1: 240 + 315 + 180 = ? Step 2: 800 âˆ’ ? = remaining',
        steps: [
          ...
          { display: 'Step 2: 800 âˆ’ 735 = 65 more needed', explanation: 'Subtract from the goal. 800 âˆ’ 735 = 65 voters still needed.', visual: '65 revealed' }
        ],
        sage: "Three numbers to add â€” do it two at a time. First pair, then add the third. Then subtract from the goal."
      }
    ],
    ...
    phase3_practice: [
      {
        ...
        hint: 'Equal groups â€” multiply.',
        choices: ['400', '420', '450', '480'],
        answer: 2,
        correctFeedback: '6 Ã— 75 = 450 marchers. 6Ã—70=420 and 6Ã—5=30. 420+30=450.',
        wrongFeedback: '6 Ã— 75: break it up. 6Ã—70=420 and 6Ã—5=30. Add: 450.',
        xp: 10
      },
      {
        id: 'diaspora-d2-p2',
      ...
      },
      {
        ...
        hint: 'Think: 8 Ã— ? = 5,000. Or divide 5,000 Ã· 8.',
        answer: '625',
        correctFeedback: '5,000 Ã· 8 = 625 flyers per neighborhood.',
        wrongFeedback: '8 Ã— 625 = 5,000. So 5,000 Ã· 8 = 625.'
      },
      {
        id: 'diaspora-d2-p4',
        type: 'mcq',
        ...
        answer: 2,
        correctFeedback: '420+385+540=1,345. 1,500âˆ’1,345=155 more voters needed.',
        wrongFeedback: 'Add: 420+385=805, then 805+540=1,345. Then 1,500âˆ’1,345=155.'
      },
      {
        id: 'diaspora-d2-p5',
        type: 'true_false',
        ...
        answer: true,
        correctFeedback: '7Ã—80=560 and 7Ã—5=35. 560+35=595. Correct!',
        wrongFeedback: '7Ã—85: 7Ã—80=560 and 7Ã—5=35. 560+35=595. The statement is true.'
      }
    ],
    ...
    phase4_test: [
      {
        ...
        hint_disabled: true,
        answer: '585',
        correctFeedback: '9 Ã— 65 = 585. 9Ã—60=540 and 9Ã—5=45. 540+45=585.',
        wrongFeedback: 'Use the distributive property: 9Ã—60=540 and 9Ã—5=45. Add: 540+45=585.'
      },
      {
        id: 'diaspora-d2-t2',
        standard: '3.NBT.A.2',
        ...
        hint_disabled: true,
        answer: '1653',
        correctFeedback: '3,500 âˆ’ 1,847 = 1,653 leaflets remaining.',
        wrongFeedback: 'Subtract carefully with regrouping: 3,500 âˆ’ 1,847 = 1,653.'
      },
      {
        id: 'diaspora-d2-t3',
        standard: '3.OA.D.8',
        ...
        answer: 2,
        correctFeedback: '850+1,200+975=3,025. 4,125âˆ’3,025=1,100 at the fourth rally.',
        wrongFeedback: 'Add the first three: 850+1,200+975=3,025. Subtract from total: 4,125âˆ’3,025=1,100.'
      },
      {
        id: 'diaspora-d2-t4',
        standard: '3.OA.D.8',
        ...
        hint_disabled: true,
        answer: true,
        correctFeedback: '432 Ã· 6 = 72. Check: 6 Ã— 72 = 432. Correct!',
        wrongFeedback: '432 Ã· 6 = 72. Verify: 6 Ã— 72 = 432. The statement is true.'
      }
    ],

    wrapUp: {
      title: 'Quest Complete, King! ðŸ‘‘',
      text: "You used all four operations to solve the problems of justice â€” the same math that organizers used to plan marches, track voters, and change the law. Math is a tool for freedom.",
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  // diaspora-d4 â€” Legacy Numbers (Math, 3.OA / 3.NBT / 3.MD)
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  {
    ...
    intro: {
      kicker: 'The Diaspora Â· Final Math Quest',
      text: "King, you have traveled through eight civilizations and solved hundreds of problems along the way. This final quest brings together everything you have learned â€” addition, subtraction, multiplication, division, fractions, area, perimeter, graphs, and multi-step problem solving. The numbers in this lesson are drawn from real history. Use your full mathematical power.",
      sage: "This is the final quest, King. Every skill you have built on this journey comes together here. Show the kingdom what you know. ðŸ‘‘"
    },
    ...
    phase1_concept: {
      ...
      example: {
        ...
        equation: 'Step 1: 4Ã—125=500. Step 2: 230Ã·4=57.5â‰ˆ58. Step 3: 125+58=183 per neighborhood.',
        visual: 'three_step',
        visual_data: {
          type: 'multi_step',
          steps: ['Multiply: 4Ã—125=500', 'Divide: 230Ã·4â‰ˆ58', 'Add: 125+58=183'],
          label: 'Three operations, one problem'
        }
      },
      sage: "Label each part â€” what is it asking? Then choose your operation. Never rush into calculating before you understand what you need."
    },
    phase2_worked: [
      {
        ...
        equation: '250,000 Ã· 3,125 = ?   Then round to nearest 10.',
        steps: [
          { display: '250,000 Ã· 3,125 â€” estimate first', explanation: 'Round both: 250,000 Ã· 3,000 â‰ˆ 83 per bus.', visual: 'estimate shown' },
          { display: 'Exact: 250,000 Ã· 3,125 = 80', explanation: '3,125 Ã— 80 = 250,000. Exactly 80 people per bus.', visual: '80 revealed' },
      ...
      },
      {
        ...
        equation: 'Part A: $340,000 Ã· 8. Part B: $40,000/$340,000 = what fraction?',
        steps: [
          { display: 'Part A: $340,000 Ã· 8 = ?', explanation: '34 Ã· 8 is not exact, so we scale: 340,000 Ã· 8. 8Ã—40,000=320,000. Remainder: 20,000Ã·8=2,500. Total: $42,500 per investor.', visual: '$42,500 revealed' },
          { display: 'Part B: Morgan fraction = 40,000/340,000', explanation: 'Simplify: both divisible by 40,000. 40,000Ã·40,000=1. 340,000Ã·40,000=8.5 â€” not a clean fraction. Use 2/17 after simplifying by 20,000.', visual: '2/17 shown' },
          { display: 'Morgan\'s $40,000 out of $340,000 total â‰ˆ about 1/8 of the total value', explanation: 'Exact fraction is 2/17, but approximately 1 out of every 8-9 dollars came from Morgan\'s patent.', visual: 'fraction comparison' }
        ],
        sage: "Real-world problems don't always give clean answers. The skill is knowing how to interpret the numbers you get â€” not just calculating them."
      }
    ],
    ...
    phase3_practice: [
      {
        ...
        answer: '75000',
        correctFeedback: '450,000 Ã· 6 = 75,000 members per region.',
        wrongFeedback: '45 Ã· 6 = 7.5 â€” try 6 Ã— 75 = 450. So 450,000 Ã· 6 = 75,000.'
      },
      {
        id: 'diaspora-d4-p2',
        type: 'mcq',
        ...
        answer: 2,
        correctFeedback: '47+63=110 poems total. 110 Ã— 3/5 = 110Ã·5Ã—3 = 22Ã—3 = 66 poems.',
        wrongFeedback: 'First: 47+63=110. Then 3/5 of 110: 110Ã·5=22, then 22Ã—3=66.'
      },
      {
        id: 'diaspora-d4-p3',
        type: 'input',
        ...
        answer: '360',
        correctFeedback: '24 Ã— 15 = 360 square meters.',
        wrongFeedback: '24 Ã— 15: 24Ã—10=240 and 24Ã—5=120. 240+120=360 square meters.'
      },
      {
        id: 'diaspora-d4-p4',
        type: 'mcq',
        ...
        answer: 1,
        correctFeedback: '4,000 âˆ’ 2,856 = 1,144. Rounded to nearest 100: 1,100.',
        wrongFeedback: '4,000âˆ’2,856=1,144. Tens digit of 1,144 is 4 < 5, so round DOWN to 1,100.'
      },
      {
        id: 'diaspora-d4-p5',
        type: 'true_false',
        ...
        hint: '8 Ã— 3 = ?',
        answer: true,
        correctFeedback: '8 Ã— 3 = 24 kilometers. Correct!',
        wrongFeedback: '8 Ã— 3 = 24. The statement is true.'
      }
    ],
    ...
    phase4_test: [
      {
        ...
        hint_disabled: true,
        answer: '595',
        correctFeedback: '7 Ã— 85 = 595. 7Ã—80=560 and 7Ã—5=35. 560+35=595.',
        wrongFeedback: '7 Ã— 85: distributive property. 7Ã—80=560 and 7Ã—5=35. Add: 595.'
      },
      {
        id: 'diaspora-d4-t2',
        standard: '3.NBT.A.2',
      ...
      },
      {
        ...
        hint_disabled: true,
        answer: '600',
        correctFeedback: '$5,400 Ã· 9 = $600 per event.',
        wrongFeedback: '9 Ã— 600 = 5,400. So 5,400 Ã· 9 = 600.'
      },
      {
        id: 'diaspora-d4-t4',
        standard: '3.MD.C.7',
